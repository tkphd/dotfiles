...
alias sa="sacct --format=JobID,JobName%16,Partition,ReqCPUS,NodeList%8,State,Start,Elapsed,CPUTime -u ${USER} -S $(date --date='last week' +%m%d%y)"
alias sq="squeue -o \"%7i %11j %3t %7q %11P %9Q %6D %5C %20S %12L %17R %Y\" -u tnk10"
