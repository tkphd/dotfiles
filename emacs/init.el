...
(custom-set-variables
 ...
 '(package-selected-packages
   '(csv adafruit-wisdom all-the-icons anzu better-defaults bug-hunter clean-aindent-mode company company-anaconda company-jedi company-lua company-math company-quickhelp-terminal company-shell company-terraform counsel counsel-pydoc counsel-projectile csv-mode dismal dockerfile-mode dtrt-indent edit-indirect editorconfig elisp-format elisp-lint ess flycheck flycheck-julia flycheck-pycheckers flycheck-pyflakes flycheck-yamllint flymake-sass gcode-mode helm helm-directory helm-file-preview helm-flycheck highlight-doxygen iedit julia-formatter julia-mode langtool lsp-python-ms lua-mode markdown-mode multi-line neotree night-owl-theme olivetti org-projectile-helm pandoc-mode poetry poly-R poly-ansible poly-rst popup-complete projectile py-autopep8 pyvenv-auto rainbow-mode rdf-prefix rst rust-mode scad-mode snakemake-mode term-projectile toml-mode typescript-mode undo-tree unicode-troll-stopper use-package v-mode virtualenv volatile-highlights web-mode ws-butler yaml-mode yasnippet zygospore)))
